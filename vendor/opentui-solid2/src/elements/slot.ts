...
class SlotBaseRenderable extends BaseRenderable {
  ...
  public add(_obj: BaseRenderable | unknown, _index?: number): number {
  ...
  public insertBefore(_obj: BaseRenderable | unknown, _anchor: BaseRenderable | unknown): void {
    throw new Error("Can't add children on an Slot renderable");
  }

  public getRenderable(_id: string): BaseRenderable | undefined {
    return undefined;
  }
  ...
  public findDescendantById(_id: string): BaseRenderable | undefined {
    return undefined;
  }
}
